...
#ifndef XSMP_PERSIST_STDSET_H_
#define XSMP_PERSIST_STDSET_H_
...
template <typename K, typename Compare> struct Helper<std::set<K, Compare>> {
  using type = std::set<K, Compare>;
