...
#ifndef XSMP_PERSIST_STDUNORDEREDSET_H_
#define XSMP_PERSIST_STDUNORDEREDSET_H_
...
struct Helper<std::unordered_set<K, Compare>> {
  using type = std::unordered_set<K, Compare>;
...
#endif // XSMP_PERSIST_STDUNORDEREDSET_H_
