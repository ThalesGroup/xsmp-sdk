...
[[ noreturn ]] void throwCannotStore(const ::Smp::IObject *sender,
        const std::string &msg = "The component can't be stored");

[[ noreturn ]] void throwCannotRestore(const ::Smp::IObject *sender,
        const std::string &msg = "The component can't be restored");
...
[[ noreturn ]] void throwInvalidComponentState(const ::Smp::IComponent *sender,
...
[[ noreturn ]] void throwEventSinkAlreadySubscribed(
        const ::Smp::IObject *sender, const ::Smp::IEventSource *eventSource,
        const ::Smp::IEventSink *eventSink);

[[ noreturn ]] void throwEventSinkNotSubscribed(const ::Smp::IObject *sender,
        const ::Smp::IEventSource *eventSource,
        const ::Smp::IEventSink *eventSink);
...
[[ noreturn ]] void throwInvalidArraySize(
        const ::Smp::ISimpleArrayField *sender, ::Smp::UInt64 invalidSize);
