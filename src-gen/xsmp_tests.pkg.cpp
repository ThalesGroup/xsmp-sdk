...
// -----------------------------------------------------------------------------
// File Name    : xsmp_tests.pkg.cpp
// Generated by : XsmpSdkGenerator-2.0.2
// -----------------------------------------------------------------------------
/// @file xsmp_tests.pkg.cpp
...
extern "C" {
/// Global Initialise function of Package xsmp_tests.
...
DLL_EXPORT bool Initialise(::Smp::ISimulator *simulator,
  ...
  return Initialise_xsmp_tests(simulator, typeRegistry);
}
}
...
#if ECSS_SMP_VERSION >= 202503L
extern "C" {
/// Global GetSmpVersion function of Package xsmp_tests.
...
/// against.
DLL_EXPORT ::Smp::UInt64 GetSmpVersion() { return GetSmpVersion_xsmp_tests(); }
}
#endif
