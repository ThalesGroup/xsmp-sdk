...
// -----------------------------------------------------------------------------
// File Name    : xsmp_link_registry.pkg.cpp
// Generated by : XsmpSdkGenerator-2.0.2
// -----------------------------------------------------------------------------
/// @file xsmp_link_registry.pkg.cpp
...
#if ECSS_SMP_VERSION >= 202503L
extern "C" {
/// Global GetSmpVersion function of Package xsmp_link_registry.
...
DLL_EXPORT ::Smp::UInt64 GetSmpVersion() {
  return GetSmpVersion_xsmp_link_registry();
}
}
#endif
