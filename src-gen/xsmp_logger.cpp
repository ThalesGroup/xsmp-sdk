...
// -----------------------------------------------------------------------------
// File Name    : xsmp_logger.cpp
// Generated by : XsmpSdkGenerator-2.0.2
// -----------------------------------------------------------------------------
/// @file xsmp_logger.cpp
...
extern "C" {
/// Initialise Package xsmp_logger.
...
bool Initialise_xsmp_logger(
  ...
  // Register Service XsmpLogger
  simulator->AddService(new ::Xsmp::Services::XsmpLogger("XsmpLogger", // Name
                                                         "", // Description
                                                         simulator, // Parent
                                                         simulator  // Simulator
                                                         ));
...
/// Get the revision of the SMP standard Package xsmp_logger was
/// built against.
/// @return The revision of the SMP standard.
::Smp::UInt64 GetSmpVersion_xsmp_logger() { return ECSS_SMP_VERSION; }
#else
/// Finalise Package xsmp_logger.
/// @return True if finalisation was successful, false otherwise.
bool Finalise_xsmp_logger() {
