...
void ModelWithPropertiesGen::Publish(::Smp::IPublication *receiver) {
    ...
    receiver->PublishField("int_field", "", &int_field,
    ...
    receiver->PublishProperty("enum_property", "",
            ::Xsmp::Tests::Types::Uuid_Enum1, ::Smp::AccessKind::AK_ReadWrite,
            ::Smp::ViewKind::VK_None);
    // Publish Property string_property
    receiver->PublishProperty("string_property", "",
            ::Xsmp::Tests::Types::Uuid_String1, ::Smp::AccessKind::AK_ReadWrite,
            ::Smp::ViewKind::VK_None);
    ...
    receiver->PublishProperty("readonly_enum_property", "",
            ::Xsmp::Tests::Types::Uuid_Enum1, ::Smp::AccessKind::AK_ReadOnly,
            ::Smp::ViewKind::VK_None);
    // Publish Property readonly_string_property
    receiver->PublishProperty("readonly_string_property", "",
            ::Xsmp::Tests::Types::Uuid_String1, ::Smp::AccessKind::AK_ReadOnly,
            ::Smp::ViewKind::VK_None);
    // Publish Property readonly_int_property
    receiver->PublishProperty("readonly_int_property", "",
            ::Smp::Uuids::Uuid_Int32, ::Smp::AccessKind::AK_ReadOnly,
            ::Smp::ViewKind::VK_None);
    // Publish Property readonly_float_property
    receiver->PublishProperty("readonly_float_property", "",
            ::Smp::Uuids::Uuid_Float64, ::Smp::AccessKind::AK_ReadOnly,
            ::Smp::ViewKind::VK_None);
    // Publish Property writeonly_enum_property
    receiver->PublishProperty("writeonly_enum_property", "",
            ::Xsmp::Tests::Types::Uuid_Enum1, ::Smp::AccessKind::AK_WriteOnly,
            ::Smp::ViewKind::VK_None);
    // Publish Property writeonly_string_property
    receiver->PublishProperty("writeonly_string_property", "",
            ::Xsmp::Tests::Types::Uuid_String1, ::Smp::AccessKind::AK_WriteOnly,
            ::Smp::ViewKind::VK_None);
    // Publish Property writeonly_int_property
    receiver->PublishProperty("writeonly_int_property", "",
            ::Smp::Uuids::Uuid_Int32, ::Smp::AccessKind::AK_WriteOnly,
            ::Smp::ViewKind::VK_None);
    // Publish Property writeonly_float_property
    receiver->PublishProperty("writeonly_float_property", "",
            ::Smp::Uuids::Uuid_Float64, ::Smp::AccessKind::AK_WriteOnly,
            ::Smp::ViewKind::VK_None);
    ...
    receiver->PublishProperty("static_enum_property", "",
            ::Xsmp::Tests::Types::Uuid_Enum1, ::Smp::AccessKind::AK_ReadWrite,
            ::Smp::ViewKind::VK_None);
    // Publish Property static_string_property
    receiver->PublishProperty("static_string_property", "",
            ::Xsmp::Tests::Types::Uuid_String1, ::Smp::AccessKind::AK_ReadWrite,
            ::Smp::ViewKind::VK_None);
    // Publish Property static_int_property
    receiver->PublishProperty("static_int_property", "",
            ::Smp::Uuids::Uuid_Int32, ::Smp::AccessKind::AK_ReadWrite,
            ::Smp::ViewKind::VK_None);
    // Publish Property static_float_property
    receiver->PublishProperty("static_float_property", "",
            ::Smp::Uuids::Uuid_Float64, ::Smp::AccessKind::AK_ReadWrite,
            ::Smp::ViewKind::VK_None);
    // Publish Property readonly_static_enum_property
    receiver->PublishProperty("readonly_static_enum_property", "",
            ::Xsmp::Tests::Types::Uuid_Enum1, ::Smp::AccessKind::AK_ReadOnly,
            ::Smp::ViewKind::VK_None);
    // Publish Property readonly_static_string_property
    receiver->PublishProperty("readonly_static_string_property", "",
            ::Xsmp::Tests::Types::Uuid_String1, ::Smp::AccessKind::AK_ReadOnly,
            ::Smp::ViewKind::VK_None);
    // Publish Property readonly_static_int_property
    receiver->PublishProperty("readonly_static_int_property", "",
            ::Smp::Uuids::Uuid_Int32, ::Smp::AccessKind::AK_ReadOnly,
            ::Smp::ViewKind::VK_None);
    // Publish Property readonly_static_float_property
    receiver->PublishProperty("readonly_static_float_property", "",
            ::Smp::Uuids::Uuid_Float64, ::Smp::AccessKind::AK_ReadOnly,
            ::Smp::ViewKind::VK_None);
    // Publish Property writeonly_static_enum_property
    receiver->PublishProperty("writeonly_static_enum_property", "",
            ::Xsmp::Tests::Types::Uuid_Enum1, ::Smp::AccessKind::AK_WriteOnly,
            ::Smp::ViewKind::VK_None);
    ...
    receiver->PublishProperty("writeonly_static_int_property", "",
            ::Smp::Uuids::Uuid_Int32, ::Smp::AccessKind::AK_WriteOnly,
            ::Smp::ViewKind::VK_None);
    // Publish Property writeonly_static_float_property
    receiver->PublishProperty("writeonly_static_float_property", "",
            ::Smp::Uuids::Uuid_Float64, ::Smp::AccessKind::AK_WriteOnly,
            ::Smp::ViewKind::VK_None);
...
void ModelWithPropertiesGen::Configure(::Smp::Services::ILogger *logger,
...
ModelWithPropertiesGen::RequestHandlers ModelWithPropertiesGen::requestHandlers =
        InitRequestHandlers();

ModelWithPropertiesGen::RequestHandlers ModelWithPropertiesGen::InitRequestHandlers() {
    ...
    if (handlers.find("set_enum_property") == handlers.end()) {
        handlers["set_enum_property"] =
                [](ModelWithPropertiesGen *component,
                        ::Smp::IRequest *request) {
                    /// Invoke set_enum_property
                    component->set_enum_property(
                            ::Xsmp::Request::get < ::Xsmp::Tests::Types::Enum1
                                    > (component, request, "enum_property", ::Smp::PrimitiveTypeKind::PTK_Int32));
                };
    }
    ...
    if (handlers.find("set_int_property") == handlers.end()) {
        handlers["set_int_property"] =
                [](ModelWithPropertiesGen *component,
                        ::Smp::IRequest *request) {
                    /// Invoke set_int_property
                    component->set_int_property(
                            ::Xsmp::Request::get < ::Smp::Int32
                                    > (component, request, "int_property", ::Smp::PrimitiveTypeKind::PTK_Int32));
                };
    }
    ...
    if (handlers.find("set_float_property") == handlers.end()) {
        handlers["set_float_property"] =
                [](ModelWithPropertiesGen *component,
                        ::Smp::IRequest *request) {
                    /// Invoke set_float_property
                    component->set_float_property(
                            ::Xsmp::Request::get < ::Smp::Float64
                                    > (component, request, "float_property", ::Smp::PrimitiveTypeKind::PTK_Float64));
                };
    }
        ...
        handlers["set_writeonly_enum_property"] =
                [](ModelWithPropertiesGen *component,
                    ...
                    component->set_writeonly_enum_property(
                            ::Xsmp::Request::get < ::Xsmp::Tests::Types::Enum1
                                    > (component, request, "writeonly_enum_property", ::Smp::PrimitiveTypeKind::PTK_Int32));
                };
    }
        ...
        handlers["set_writeonly_string_property"] =
                [](ModelWithPropertiesGen *component,
                    ...
                    component->set_writeonly_string_property(
                            ::Xsmp::Request::get < ::Xsmp::Tests::Types::String1
                                    > (component, request, "writeonly_string_property", ::Smp::PrimitiveTypeKind::PTK_String8));
                };
    }
        ...
        handlers["set_writeonly_int_property"] =
                [](ModelWithPropertiesGen *component,
                    ...
                    component->set_writeonly_int_property(
                            ::Xsmp::Request::get < ::Smp::Int32
                                    > (component, request, "writeonly_int_property", ::Smp::PrimitiveTypeKind::PTK_Int32));
                };
    }
        ...
        handlers["set_writeonly_float_property"] =
                [](ModelWithPropertiesGen *component,
                    ...
                    component->set_writeonly_float_property(
                            ::Xsmp::Request::get < ::Smp::Float64
                                    > (component, request, "writeonly_float_property", ::Smp::PrimitiveTypeKind::PTK_Float64));
                };
    }
    if (handlers.find("get_static_enum_property") == handlers.end()) {
        handlers["get_static_enum_property"] = [](
                ModelWithPropertiesGen *component, ::Smp::IRequest *request) {
    ...
    if (handlers.find("set_static_enum_property") == handlers.end()) {
        handlers["set_static_enum_property"] =
                [](ModelWithPropertiesGen *component,
                        ::Smp::IRequest *request) {
                    /// Invoke set_static_enum_property
                    component->set_static_enum_property(
                            ::Xsmp::Request::get < ::Xsmp::Tests::Types::Enum1
                                    > (component, request, "static_enum_property", ::Smp::PrimitiveTypeKind::PTK_Int32));
                };
    }
        ...
        handlers["set_static_string_property"] =
                [](ModelWithPropertiesGen *component,
                    ...
                    component->set_static_string_property(
                            ::Xsmp::Request::get < ::Xsmp::Tests::Types::String1
                                    > (component, request, "static_string_property", ::Smp::PrimitiveTypeKind::PTK_String8));
                };
    }
    if (handlers.find("get_static_int_property") == handlers.end()) {
        handlers["get_static_int_property"] = [](
                ModelWithPropertiesGen *component, ::Smp::IRequest *request) {
    ...
    if (handlers.find("set_static_int_property") == handlers.end()) {
        handlers["set_static_int_property"] =
                [](ModelWithPropertiesGen *component,
                        ::Smp::IRequest *request) {
                    /// Invoke set_static_int_property
                    component->set_static_int_property(
                            ::Xsmp::Request::get < ::Smp::Int32
                                    > (component, request, "static_int_property", ::Smp::PrimitiveTypeKind::PTK_Int32));
                };
    }
        ...
        handlers["set_static_float_property"] =
                [](ModelWithPropertiesGen *component,
                    ...
                    component->set_static_float_property(
                            ::Xsmp::Request::get < ::Smp::Float64
                                    > (component, request, "static_float_property", ::Smp::PrimitiveTypeKind::PTK_Float64));
                };
    }
    ...
    if (handlers.find("get_readonly_static_string_property")
            == handlers.end()) {
        ...
        handlers["set_writeonly_static_enum_property"] =
                [](ModelWithPropertiesGen *component,
                    ...
                    component->set_writeonly_static_enum_property(
                            ::Xsmp::Request::get < ::Xsmp::Tests::Types::Enum1
                                    > (component, request, "writeonly_static_enum_property", ::Smp::PrimitiveTypeKind::PTK_Int32));
                };
    }
    if (handlers.find("set_writeonly_static_string_property")
            == handlers.end()) {
        handlers["set_writeonly_static_string_property"] =
                [](ModelWithPropertiesGen *component,
                    ...
                    component->set_writeonly_static_string_property(
                            ::Xsmp::Request::get < ::Xsmp::Tests::Types::String1
                                    > (component, request, "writeonly_static_string_property", ::Smp::PrimitiveTypeKind::PTK_String8));
                };
    }
        ...
        handlers["set_writeonly_static_int_property"] =
                [](ModelWithPropertiesGen *component,
                    ...
                    component->set_writeonly_static_int_property(
                            ::Xsmp::Request::get < ::Smp::Int32
                                    > (component, request, "writeonly_static_int_property", ::Smp::PrimitiveTypeKind::PTK_Int32));
                };
    }
    if (handlers.find("set_writeonly_static_float_property")
            == handlers.end()) {
        handlers["set_writeonly_static_float_property"] =
                [](ModelWithPropertiesGen *component,
                    ...
                    component->set_writeonly_static_float_property(
                            ::Xsmp::Request::get < ::Smp::Float64
                                    > (component, request, "writeonly_static_float_property", ::Smp::PrimitiveTypeKind::PTK_Float64));
                };
    }
    return handlers;
}
...
::Xsmp::Tests::Types::Enum1 ModelWithPropertiesGen::get_readonly_enum_property() {
    return this->enum_field;
}
::Xsmp::Tests::Types::String1 ModelWithPropertiesGen::get_readonly_string_property() {
    return this->string_field;
}
...
::Xsmp::Tests::Types::String1 ModelWithPropertiesGen::get_static_string_property() {
...
::Xsmp::Tests::Types::Enum1 ModelWithPropertiesGen::get_readonly_static_enum_property() {
    return ModelWithPropertiesGen::static_enum_field;
}
::Xsmp::Tests::Types::String1 ModelWithPropertiesGen::get_readonly_static_string_property() {
    return ModelWithPropertiesGen::static_string_field;
}
