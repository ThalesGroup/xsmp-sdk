...
static constexpr ::Smp::Uuid Uuid_ModelWithSimpleFields { 0xdf6ddf61U, 0xc676U,
        0x47f5U, 0x8764U, 0xfc6d889318ffU };
...
public:
    ...
    ModelWithSimpleFieldsGen& operator=(const ModelWithSimpleFieldsGen&) = delete;
...
private:
    ...
    ::Xsmp::Field<::Xsmp::Tests::Types::SimpleStructure>::forcible struct1Forcible;
    ...
    ::Xsmp::Field<::Smp::Bool>::transient::input::output::forcible::failure booleanAll;
    ::Xsmp::Field<::Smp::Char8>::transient::input::output::forcible::failure char8All;
    ::Xsmp::Field<::Xsmp::Tests::Types::Enum1>::transient::input::output::forcible::failure enum1All;
    ::Xsmp::Field<::Xsmp::Tests::Types::String1>::transient::input::output::forcible::failure string1All;
