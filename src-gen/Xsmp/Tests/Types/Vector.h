...
struct Vector {
    ...
    struct _Field: public _BASE {
        ...
        _Field(::Smp::Publication::ITypeRegistry *typeRegistry,
                ...
                /// x initialization
                x { typeRegistry, ::Smp::Uuids::Uuid_Float64, "x", "", this,
                        view, value.x },
                /// y initialization
                y { typeRegistry, ::Smp::Uuids::Uuid_Float64, "y", "", this,
                        view, value.y },
                /// z initialization
                z { typeRegistry, ::Smp::Uuids::Uuid_Float64, "z", "", this,
                        view, value.z } {
        }
        ...
        operator ::Xsmp::Tests::Types::Vector() const noexcept {
            return {x, y, z};
        }
