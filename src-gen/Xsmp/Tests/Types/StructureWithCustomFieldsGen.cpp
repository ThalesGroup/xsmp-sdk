...
void StructureWithCustomFields::_Register(
    ...
    pStructure->AddField("enum1Input", "", ::Xsmp::Tests::Types::Uuid_Enum1 ///UUID of the Field Type
    ...
    pStructure->AddField("string1Input", "", ::Xsmp::Tests::Types::Uuid_String1 ///UUID of the Field Type
    ...
    pStructure->AddField("float1Input", "", ::Xsmp::Tests::Types::Uuid_Float1 ///UUID of the Field Type
    ...
    pStructure->AddField("integer1Input", "",
    ...
    pStructure->AddField("struct1Input", "",
    ...
    pStructure->AddField("booleanTransient", "", ::Smp::Uuids::Uuid_Bool ///UUID of the Field Type
    ...
    pStructure->AddField("char8Transient", "", ::Smp::Uuids::Uuid_Char8 ///UUID of the Field Type
    ...
    pStructure->AddField("enum1Transient", "", ::Xsmp::Tests::Types::Uuid_Enum1 ///UUID of the Field Type
    ...
    pStructure->AddField("string1Transient", "",
    ...
    pStructure->AddField("float1Transient", "",
    ...
    pStructure->AddField("integer1Transient", "",
            ::Xsmp::Tests::Types::Uuid_Integer1  ///UUID of the Field Type
    ...
    pStructure->AddField("struct1Transient", "",
            ::Xsmp::Tests::Types::Uuid_SimpleStructure ///UUID of the Field Type
    ...
    pStructure->AddField("booleanOutput", "", ::Smp::Uuids::Uuid_Bool ///UUID of the Field Type
    ...
    pStructure->AddField("char8Output", "", ::Smp::Uuids::Uuid_Char8 ///UUID of the Field Type
    ...
    pStructure->AddField("enum1Output", "", ::Xsmp::Tests::Types::Uuid_Enum1 ///UUID of the Field Type
    ...
    pStructure->AddField("string1Output", "", ::Xsmp::Tests::Types::Uuid_String1 ///UUID of the Field Type
    ...
    pStructure->AddField("float1Output", "", ::Xsmp::Tests::Types::Uuid_Float1 ///UUID of the Field Type
    ...
    pStructure->AddField("integer1Output", "",
            ::Xsmp::Tests::Types::Uuid_Integer1  ///UUID of the Field Type
    ...
    pStructure->AddField("struct1Output", "",
            ::Xsmp::Tests::Types::Uuid_SimpleStructure ///UUID of the Field Type
    ...
    pStructure->AddField("booleanForcible", "", ::Smp::Uuids::Uuid_Bool ///UUID of the Field Type
    ...
    pStructure->AddField("char8Forcible", "", ::Smp::Uuids::Uuid_Char8 ///UUID of the Field Type
    ...
    pStructure->AddField("enum1Forcible", "", ::Xsmp::Tests::Types::Uuid_Enum1 ///UUID of the Field Type
    ...
    pStructure->AddField("string1Forcible", "",
            ::Xsmp::Tests::Types::Uuid_String1  ///UUID of the Field Type
    ...
    pStructure->AddField("float1Forcible", "", ::Xsmp::Tests::Types::Uuid_Float1 ///UUID of the Field Type
    ...
    pStructure->AddField("integer1Forcible", "",
            ::Xsmp::Tests::Types::Uuid_Integer1  ///UUID of the Field Type
    ...
    pStructure->AddField("struct1Forcible", "",
            ::Xsmp::Tests::Types::Uuid_SimpleStructure ///UUID of the Field Type
    ...
    pStructure->AddField("booleanFailure", "", ::Smp::Uuids::Uuid_Bool ///UUID of the Field Type
    ...
    pStructure->AddField("char8Failure", "", ::Smp::Uuids::Uuid_Char8 ///UUID of the Field Type
    ...
    pStructure->AddField("enum1Failure", "", ::Xsmp::Tests::Types::Uuid_Enum1 ///UUID of the Field Type
    ...
    pStructure->AddField("string1Failure", "",
            ::Xsmp::Tests::Types::Uuid_String1  ///UUID of the Field Type
    ...
    pStructure->AddField("float1Failure", "", ::Xsmp::Tests::Types::Uuid_Float1 ///UUID of the Field Type
    ...
    pStructure->AddField("integer1Failure", "",
            ::Xsmp::Tests::Types::Uuid_Integer1  ///UUID of the Field Type
    ...
    pStructure->AddField("struct1Failure", "",
            ::Xsmp::Tests::Types::Uuid_SimpleStructure ///UUID of the Field Type
    ...
    pStructure->AddField("booleanAll", "", ::Smp::Uuids::Uuid_Bool ///UUID of the Field Type
    ...
    pStructure->AddField("char8All", "", ::Smp::Uuids::Uuid_Char8 ///UUID of the Field Type
    ...
    pStructure->AddField("enum1All", "", ::Xsmp::Tests::Types::Uuid_Enum1 ///UUID of the Field Type
    ...
    pStructure->AddField("string1All", "", ::Xsmp::Tests::Types::Uuid_String1 ///UUID of the Field Type
    ...
    pStructure->AddField("float1All", "", ::Xsmp::Tests::Types::Uuid_Float1 ///UUID of the Field Type
    ...
    pStructure->AddField("integer1All", "", ::Xsmp::Tests::Types::Uuid_Integer1 ///UUID of the Field Type
    ...
    pStructure->AddField("struct1All", "",
            ::Xsmp::Tests::Types::Uuid_SimpleStructure ///UUID of the Field Type
