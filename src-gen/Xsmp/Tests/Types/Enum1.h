...
static constexpr ::Smp::Uuid Uuid_Enum1 { 0xebca672cU, 0xed02U, 0x4decU,
        0x8199U, 0x7049f2f3c03bU };

void _Register_Enum1(::Smp::Publication::ITypeRegistry *registry);

const std::map<Enum1, std::string> Enum1_name_map = { { Enum1::L1, "L1" }, {
        Enum1::L2, "L2" }, { Enum1::L3, "L3" } };
