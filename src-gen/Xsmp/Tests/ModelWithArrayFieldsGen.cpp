...
void ModelWithArrayFieldsGen::Publish(::Smp::IPublication *receiver) {
    ...
    receiver->PublishField("boolean", "", &boolean,
            ::Xsmp::Tests::Types::Uuid_BoolArray, ::Smp::ViewKind::VK_None,
            true, false, false);
    // Publish field char8
    receiver->PublishField("char8", "", &char8,
            ::Xsmp::Tests::Types::Uuid_Char8Array, ::Smp::ViewKind::VK_None,
            true, false, false);
    // Publish field enum1
    receiver->PublishField("enum1", "", &enum1,
            ::Xsmp::Tests::Types::Uuid_Enum1Array, ::Smp::ViewKind::VK_None,
            true, false, false);
    // Publish field string1
    receiver->PublishField("string1", "", &string1,
            ::Xsmp::Tests::Types::Uuid_String1Array, ::Smp::ViewKind::VK_None,
            true, false, false);
    // Publish field float1
    receiver->PublishField("float1", "", &float1,
            ::Xsmp::Tests::Types::Uuid_Float1Array, ::Smp::ViewKind::VK_None,
            true, false, false);
    // Publish field integer1
    receiver->PublishField("integer1", "", &integer1,
            ::Xsmp::Tests::Types::Uuid_Integer1Array, ::Smp::ViewKind::VK_None,
            true, false, false);
...
void ModelWithArrayFieldsGen::Configure(::Smp::Services::ILogger *logger,
