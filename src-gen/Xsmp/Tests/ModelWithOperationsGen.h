...
static constexpr ::Smp::Uuid Uuid_ModelWithOperations { 0x5c52ca42U, 0x4992U,
        0x4401U, 0x9408U, 0x8d994b1fbabeU };
...
public:
    ...
    ~ModelWithOperationsGen() override;
    ...
    // --------------------------- IDynamicInvocation ---------------------------
    // ----------------------------------------------------------------------------------
    using RequestHandlers = std::map<std::string, std::function<void(ModelWithOperationsGen*, ::Smp::IRequest*)>>;
