...
XsmpTimeKeeperGen::XsmpTimeKeeperGen(::Smp::String8 name,
    ...
    : // Base class initialization
      ...
      PreSimTimeChange{"PreSimTimeChange", "", this,
                       std::bind(&XsmpTimeKeeperGen::_PreSimTimeChange, this)},
      // EntryPoint: PostSimTimeChange
      PostSimTimeChange{
          "PostSimTimeChange", "", this,
          std::bind(&XsmpTimeKeeperGen::_PostSimTimeChange, this)} {}
...
void XsmpTimeKeeperGen::Disconnect() {
  ...
  ::Xsmp::Component::Helper::Disconnect<::Xsmp::Services::XsmpTimeKeeper>(this);
