...
XsmpResolverGen::~XsmpResolverGen() {
}
...
void XsmpResolverGen::Publish(::Smp::IPublication *receiver) {
    ...
    ::Xsmp::Component::Helper::Publish < ::Xsmp::Services::XsmpResolver
            > (this, receiver);
}
...
void XsmpResolverGen::Connect(::Smp::ISimulator *simulator) {
    ...
    ::Xsmp::Component::Helper::Connect < ::Xsmp::Services::XsmpResolver
            > (this, simulator);
}

void XsmpResolverGen::Disconnect() {
    // Call user DoDisconnect if any
    ::Xsmp::Component::Helper::Disconnect < ::Xsmp::Services::XsmpResolver
            > (this);
