...
// -----------------------------------------------------------------------------
// File Name    : xsmp_logger.pkg.cpp
// Generated by : XsmpSdkGenerator-2.0.2
// -----------------------------------------------------------------------------
/// @file xsmp_logger.pkg.cpp
...
extern "C" {
/// Global Initialise function of Package xsmp_logger.
...
DLL_EXPORT bool Initialise(::Smp::ISimulator *simulator,
  ...
  return Initialise_xsmp_logger(simulator, typeRegistry);
}
}
...
extern "C" {
/// Global Finalise function of Package xsmp_logger.
...
DLL_EXPORT bool Finalise(::Smp::ISimulator *simulator) {
  ...
  return Finalise_xsmp_logger(simulator);
#else
  static_cast<void>(simulator);
  return Finalise_xsmp_logger();
#endif
}
}
...
#if ECSS_SMP_VERSION >= 202503L
extern "C" {
/// Global GetSmpVersion function of Package xsmp_logger.
...
/// against.
DLL_EXPORT ::Smp::UInt64 GetSmpVersion() { return GetSmpVersion_xsmp_logger(); }
}
#endif
