...
// -----------------------------------------------------------------------------
// File Name    : xsmp_time_keeper.pkg.cpp
// Generated by : XsmpSdkGenerator-2.0.2
// -----------------------------------------------------------------------------
/// @file xsmp_time_keeper.pkg.cpp
...
DLL_EXPORT bool Finalise(::Smp::ISimulator *simulator) {
  ...
  return Finalise_xsmp_time_keeper();
#endif
}
}
...
#if ECSS_SMP_VERSION >= 202503L
extern "C" {
/// Global GetSmpVersion function of Package xsmp_time_keeper.
...
DLL_EXPORT ::Smp::UInt64 GetSmpVersion() {
  return GetSmpVersion_xsmp_time_keeper();
}
}
#endif
