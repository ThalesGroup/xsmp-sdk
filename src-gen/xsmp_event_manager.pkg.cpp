...
// -----------------------------------------------------------------------------
// File Name    : xsmp_event_manager.pkg.cpp
// Generated by : XsmpSdkGenerator-2.0.2
// -----------------------------------------------------------------------------
/// @file xsmp_event_manager.pkg.cpp
...
extern "C" {
/// Global Initialise function of Package xsmp_event_manager.
...
DLL_EXPORT bool Initialise(::Smp::ISimulator *simulator,
  ...
  return Initialise_xsmp_event_manager(simulator, typeRegistry);
}
}
...
extern "C" {
/// Global Finalise function of Package xsmp_event_manager.
...
DLL_EXPORT bool Finalise(::Smp::ISimulator *simulator) {
  ...
  return Finalise_xsmp_event_manager(simulator);
#else
  static_cast<void>(simulator);
  return Finalise_xsmp_event_manager();
#endif
}
}
...
#if ECSS_SMP_VERSION >= 202503L
extern "C" {
/// Global GetSmpVersion function of Package xsmp_event_manager.
...
DLL_EXPORT ::Smp::UInt64 GetSmpVersion() {
  return GetSmpVersion_xsmp_event_manager();
}
}
#endif
