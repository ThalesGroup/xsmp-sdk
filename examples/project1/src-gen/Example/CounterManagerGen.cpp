...
void CounterManagerGen::Publish(::Smp::IPublication *receiver) {
  ...
  receiver->PublishProperty(
      "sum", "sum of all contained counters", ::Smp::Uuids::Uuid_Int32,
  ...
  receiver->PublishProperty(
      "count", "set all counter value", ::Smp::Uuids::Uuid_Int32,
...
CounterManagerGen::RequestHandlers CounterManagerGen::InitRequestHandlers() {
  ...
  if (handlers.find("get_sum") == handlers.end()) {
    handlers["get_sum"] = [](CounterManagerGen *component,
      ...
      ::Xsmp::Request::setReturnValue(
          request, ::Smp::PrimitiveTypeKind::PTK_Int32, component->get_sum());
    };
  }
  ...
  if (handlers.find("set_count") == handlers.end()) {
    handlers["set_count"] = [](CounterManagerGen *component,
                               ::Smp::IRequest *request) {
      /// Invoke set_count
