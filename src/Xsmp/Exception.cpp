...
public:
    ...
    Exception(const ::Smp::IObject *sender, const std::string &name,
            ...
            _sender(sender), _name(name), _description(description), _message(
                    ...
                    _name + "(" + _description + "): " + _message) {
    }
    ~Exception() noexcept override = default;
    Exception(const Exception&) = default;
    Exception& operator=(const Exception&) = default;

    const ::Smp::Char8* what() const noexcept final {
        return _whatStr.c_str();
    }
    ::Smp::String8 GetName() const noexcept final {
        return _name.c_str();
    }
    ::Smp::String8 GetDescription() const noexcept final {
        return _description.c_str();
    }
    ::Smp::String8 GetMessage() const noexcept final {
...
public:
    FieldAlreadyConnected(const ::Smp::IObject *sender,
            const ::Smp::IDataflowField *source, const ::Smp::IField *target) :
    ...
    const ::Smp::IField* GetTarget() const noexcept override {
        return _target;
    }
...
public:
    NotContained(const ::Smp::IContainer *container,
...
public:
    CannotDelete(const ::Smp::IContainer *container,
            ::Smp::IComponent *component) :
            Exception(container, __func__,
                    ...
                    "Tried to delete ", component, " component from ",
                    container,
                    " container, but the number of contained components is lower than or equal to the Lower limit: ",
                    container->GetLower()),
...
class InvalidObjectType final: public Exception, public ::Smp::InvalidObjectType {
public:
    InvalidObjectType(const ::Smp::IObject *sender,
            ::Smp::IObject *invalidObject, const std::type_info &expectedType) :
            Exception(sender, __func__, "Cannot pass an object of wrong type",

            invalidObject, " of type ", ::Xsmp::Helper::TypeName(invalidObject),
                    " cannot be casted to ",
...
public:
    CannotRemove(const ::Smp::IReference *sender, ::Smp::IComponent *component,
            ...
            Exception(sender, __func__,
                    ...
                    " reference, but the number of referenced components is lower than or equal to the Lower limit: ",
                    lowerLimit),
...
class InvalidEventSink final: public Exception, public ::Smp::InvalidEventSink {
public:
...
class EventSinkAlreadySubscribed final: public Exception,
...
public:
    ...
    EventSinkAlreadySubscribed& operator=(const EventSinkAlreadySubscribed&) = default;
...
public:
    InvalidParameterCount(const ::Smp::IOperation *sender,
            ...
            _rightNbOperationParameters(
                    static_cast<::Smp::Int32>(sender->GetParameters()->size())), _requestedNbParameters(
                    requestedNbParameters) {
    }
...
public:
    InvalidParameterType(const ::Smp::IObject *sender,
            ...
            Exception(sender, __func__,
                    ...
                    ", tried to pass parameter ", parameterName,
                    " which is of type ", invalidType,
                    " instead of expected type ", expectedType),

            _operationName(operationName), _parameterName(parameterName), _invalidType(
                    invalidType), _expectedType(expectedType) {
    }
...
class InvalidArrayIndex final: public Exception, public ::Smp::InvalidArrayIndex {
public:
...
class InvalidFieldValue final: public Exception, public ::Smp::InvalidFieldValue {
public:
...
class InvalidArrayValue final: public Exception, public ::Smp::InvalidArrayValue {
public:
    InvalidArrayValue(const ::Smp::ISimpleArrayField *sender,
            ::Smp::Int64 index, const ::Smp::AnySimple &invalidValue) :
            Exception(sender, __func__,
    ...
    ::Smp::Int64 GetInvalidValueIndex() const noexcept override {
        return _index;
    }
...
class InvalidArraySize final: public Exception, public ::Smp::InvalidArraySize {
public:
    InvalidArraySize(const ::Smp::ISimpleArrayField *sender,
            ...
            _arraySize(static_cast<::Smp::Int64>(sender->GetSize())), _invalidSize(
                    invalidSize) {
    }
    ...
    ::Smp::Int64 GetInvalidSize() const noexcept override {
        return _invalidSize;
    }
private:
    ::Smp::Int64 _arraySize;
...
public:
    InvalidEventId(const ::Smp::IObject *sender,
            ...
            Exception(sender, __func__,
                    "This exception is raised when an invalid event id is provided, e.g.when calling Subscribe(), Unsubscribe()"
                            ...
                            "SetEventMissionTime(), SetEventEpochTime(), SetEventZuluTime(), SetEventCycleTime(), SetEventCount() or RemoveEvent() "
...
class EntryPointNotSubscribed final: public Exception,
...
class EntryPointAlreadySubscribed final: public Exception,
...
public:
    EntryPointAlreadySubscribed(const ::Smp::IObject *sender,
            ...
            Exception(sender, __func__,
                    ...
                    " is already subscribed to '", eventName, "'."),
    ...
    EntryPointAlreadySubscribed& operator=(const EntryPointAlreadySubscribed&) = default;
...
class InvalidFieldType final: public Exception, public ::Smp::InvalidFieldType {
public:
...
class InvalidSimulationTime final: public Exception,
...
class InvalidPrimitiveType final: public Exception,
...
void throwInvalidEventTime(const ::Smp::IObject *sender,
    ...
    throw InvalidEventTime(sender, Duration { eventTime }, Duration {
            currentTime });
}
...
void throwInvalidSimulationTime(const ::Smp::IObject *sender,
        ::Smp::Duration current, ::Smp::Duration provided,
        ::Smp::Duration max) {
