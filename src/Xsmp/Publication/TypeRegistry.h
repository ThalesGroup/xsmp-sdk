...
public:
    ...
    ::Smp::Publication::IType* GetType(::Smp::PrimitiveTypeKind type) const
            override;
    ...
    ::Smp::Publication::IType* AddFloatType(::Smp::String8 name,
    ...
    /// @throws  ::Smp::Publication::InvalidPrimitiveType
    /// @throws  ::Smp::Publication::TypeAlreadyRegistered
    ::Smp::Publication::IType* AddIntegerType(::Smp::String8 name,
            ::Smp::String8 description, ::Smp::Uuid typeUuid,
            ::Smp::Int64 minimum, ::Smp::Int64 maximum, ::Smp::String8 unit,
            ::Smp::PrimitiveTypeKind type = ::Smp::PrimitiveTypeKind::PTK_Int32)
                    override;
    ...
    /// @return  Interface to new type.
    /// @throws  ::Smp::Publication::TypeAlreadyRegistered
    ::Smp::Publication::IArrayType* AddArrayType(::Smp::String8 name,
            ::Smp::String8 description, ::Smp::Uuid typeUuid,
    ...
    /// @throws  ::Smp::Publication::TypeAlreadyRegistered
    ::Smp::Publication::IStructureType* AddStructureType(::Smp::String8 name,
            ::Smp::String8 description, ::Smp::Uuid typeUuid) override;
