...
public:
    ...
    void PublishField(::Smp::String8 name, ::Smp::String8 description,
            ::Smp::Bool *address,
            ::Smp::ViewKind view = ::Smp::ViewKind::VK_All, ::Smp::Bool state =
                    true, ::Smp::Bool input = false, ::Smp::Bool output = false)
                    override;
    ...
    /// @throws  ::Smp::DuplicateName
    /// @throws  ::Smp::InvalidObjectName
    ::Smp::IPublication* PublishArray(::Smp::String8 name,
            ::Smp::String8 description, ::Smp::ViewKind view =
                    ::Smp::ViewKind::VK_All, ::Smp::Bool state = true) override;
    ...
    /// @throws  ::Smp::InvalidObjectName
    ::Smp::Publication::IPublishOperation* PublishOperation(::Smp::String8 name,
            ::Smp::String8 description, ::Smp::ViewKind view =
                    ::Smp::ViewKind::VK_None) override;
