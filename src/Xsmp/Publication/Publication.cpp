...
Publication::Publication(::Smp::IObject *parent,
        ...
        _parent(parent), _typeRegistry { typeRegistry }, _fields { "Fields", "",
                parent }, _allFields { &_fields }, _properties { "Properties",
                "", parent }, _operations { "Operations", "", parent } {
...
void Publication::PublishField(::Smp::String8 name, ::Smp::String8 description,
        ...
        ::Smp::Bool input, ::Smp::Bool output) {
    PublishField(name, description, address, ::Smp::Uuids::Uuid_Bool, view,
            state, input, output);
}
...
void Publication::PublishField(::Smp::String8 name, ::Smp::String8 description,
        ...
        ::Smp::Bool input, ::Smp::Bool output) {
    PublishField(name, description, address, ::Smp::Uuids::Uuid_Int8, view,
            state, input, output);
}
...
void Publication::PublishField(::Smp::String8 name, ::Smp::String8 description,
        void *address, ::Smp::Uuid typeUuid, ::Smp::ViewKind view,
        ::Smp::Bool state, ::Smp::Bool input, ::Smp::Bool output) {

    if (auto const *type = _typeRegistry->GetType(typeUuid))
        _fields.Add(
                Field::Create(name, description, _parent, address, type, view,
                        state, input, output));
    else
...
void Publication::PublishArray(::Smp::String8 name, ::Smp::String8 description,
    ...
    if (output)
        _fields.Add<AnonymousSimpleArrayDataflowField>(name, description,
                _parent, count, address, type, view, state, input, output);
    else
        _fields.Add<AnonymousSimpleArrayField>(name, description, _parent,
                count, address, type, view, state, input, output);

}

::Smp::IPublication* Publication::PublishArray(::Smp::String8 name,
        ::Smp::String8 description, ::Smp::ViewKind view, ::Smp::Bool state) {
