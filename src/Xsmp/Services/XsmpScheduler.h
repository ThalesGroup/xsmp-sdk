...
public:
    ...
    ::Smp::Services::EventId AddSimulationTimeEvent(
            ...
            ::Smp::Duration simulationTime, ::Smp::Duration cycleTime = 0,
    ...
    /// @throws  ::Smp::Services::InvalidEventId
    void SetEventRepeat(::Smp::Services::EventId event, ::Smp::Int64 repeat)
            override;
...
private:
    ...
    using EventList = std::set<::Smp::Services::EventId, std::less<std::make_unsigned_t<::Smp::Services::EventId>>>;
    ...
    mutable std::mutex _eventsMutex { }; // protection for _events, _immediate_events, _events_table and _lastEventId
    ...
    ::Smp::Services::EventId AddEvent(const ::Smp::IEntryPoint *entryPoint,
            ::Smp::Duration simulationTime, ::Smp::Duration time,
            ::Smp::Duration cycleTime, ::Smp::Int64 repeat,
            ::Smp::Services::TimeKind kind);

    void SetEventTime(::Smp::Services::EventId id,
            ::Smp::Duration simulationTime, ::Smp::Duration time,
            ::Smp::Services::TimeKind kind);
