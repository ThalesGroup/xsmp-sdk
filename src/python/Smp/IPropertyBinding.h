...
inline void RegisterIProperty(const py::module_ &m) {
  py::class_<::Smp::IProperty, ::Smp::IObject>(m, "IProperty",
      ...
      .def(
          "GetValue",
          [](const ::Smp::IProperty &self) { return convert(self.GetValue()); },
          "Provides the value of the property.")

      .def(
          "SetValue",
          [](::Smp::IProperty &self, const py::handle &value) {
            self.SetValue(
                convert(value, self.GetType()->GetPrimitiveTypeKind()));
          },
          "Sets the value of the property.", py::arg{"value"})

      .def("__bool__",
           [](const ::Smp::IProperty &self) {
      ...
      .def("__repr__",
           [](const ::Smp::IProperty &self) {
             std::stringstream ss;
             ss << "<" << ::Xsmp::Helper::GetPath(&self) << ": "
                << self.GetAccess() << " " << self.GetType()->GetName();
