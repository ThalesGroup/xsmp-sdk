...
#ifndef PYTHON_SMP_SERVICES_ILINKREGISTRY_H_
#define PYTHON_SMP_SERVICES_ILINKREGISTRY_H_
...
inline void RegisterILinkRegistry(const py::module_ &m) {
  ...
  py::class_<::Smp::Services::ILinkRegistry, ::Smp::IService>(
      m, "ILinkRegistry", py::multiple_inheritance())

      .def("AddLink", &::Smp::Services::ILinkRegistry::AddLink,
...
This number is incremented each time AddLink() is called, and decremented each time that RemoveLink() is called.)")
      ...
      .def(
          "RemoveLink", &::Smp::Services::ILinkRegistry::RemoveLink,
          py::arg("source"), py::arg("target"),
...
This method can be called several times with the same arguments, when a source component had several links to the same target component.)")
      ...
      .def(
          "GetLinkSources", &::Smp::Services::ILinkRegistry::GetLinkSources,
          py::arg("target"),
...
This method returns the collection of source components for which a link to the given target component has been added to the link registry.)")
      ...
      .def(
          "CanRemove", &::Smp::Services::ILinkRegistry::CanRemove,
          py::arg("target"),
...
#endif // PYTHON_SMP_SERVICES_ILINKREGISTRY_H_
