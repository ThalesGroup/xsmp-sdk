...
inline void RegisterILogger(const py::module_ &m) {
    py::class_<::Smp::Services::ILogger, ::Smp::IService>(m, "ILogger",
            py::multiple_inheritance())

    .def("QueryLogMessageKind", &::Smp::Services::ILogger::QueryLogMessageKind,
    ...
    .def_readonly_static("LMK_Warning", &::Smp::Services::ILogger::LMK_Warning,
