  ...
  py::class_<::Smp::Publication::ITypeRegistry>(m, "ITypeRegistry",
      ...
      .def("GetType",
           py::overload_cast<::Smp::Uuid>(
               &::Smp::Publication::ITypeRegistry::GetType, py::const_),
           py::arg("typeUuid"), py::return_value_policy::reference_internal,
