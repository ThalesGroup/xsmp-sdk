...
AnySimple::AnySimple() :
        AnySimple(PrimitiveTypeKind::PTK_None) {
}
...
AnySimple::AnySimple(const ::Smp::AnySimple &other) :
        AnySimple() {
    *this = other;
}
    ...
    if (this != &other) {
        ...
        if (other.type == PrimitiveTypeKind::PTK_String8) {
            if (other.value.string8Value) {
                ...
                std::memcpy(static_cast<void*>(dest), other.value.string8Value,
                        size);
            }
            else {
                value.string8Value = nullptr;
...
void AnySimple::SetValue(::Smp::PrimitiveTypeKind kind, ::Smp::UInt8 newValue) {
    ...
    case PrimitiveTypeKind::PTK_Int8:
        this->value.int8Value = convertIntegral<::Smp::Int8>(newValue, kind,
...
void AnySimple::SetValue(::Smp::PrimitiveTypeKind kind,
    ...
    switch (kind) {
    case PrimitiveTypeKind::PTK_UInt8:
        this->value.uInt8Value = convertIntegral<::Smp::UInt8>(newValue, kind,
    ...
    case PrimitiveTypeKind::PTK_Int8:
        ...
        break;
    case PrimitiveTypeKind::PTK_Int16:
        this->value.int16Value = convertIntegral<::Smp::Int16>(newValue, kind,
                PrimitiveTypeKind::PTK_UInt16);
        break;
    case PrimitiveTypeKind::PTK_Int32:
        this->value.int32Value = newValue;
...
void AnySimple::SetValue(::Smp::PrimitiveTypeKind kind,
    ...
    case PrimitiveTypeKind::PTK_UInt8:
        ...
        break;
    case PrimitiveTypeKind::PTK_UInt16:
        this->value.uInt16Value = convertIntegral<::Smp::UInt16>(newValue, kind,
                PrimitiveTypeKind::PTK_UInt32);
        break;
    case PrimitiveTypeKind::PTK_UInt32:
        this->value.uInt32Value = newValue;
    ...
    case PrimitiveTypeKind::PTK_Int16:
        ...
        break;
    case PrimitiveTypeKind::PTK_Int32:
        this->value.int32Value = convertIntegral<::Smp::Int32>(newValue, kind,
                PrimitiveTypeKind::PTK_UInt32);
        break;
    case PrimitiveTypeKind::PTK_Int64:
        this->value.int64Value = newValue;
    ...
    case PrimitiveTypeKind::PTK_DateTime:
        ...
        break;
    case PrimitiveTypeKind::PTK_Float32:
        this->value.float32Value = convertFloat<::Smp::Float32>(newValue, kind,
                PrimitiveTypeKind::PTK_UInt32);
        break;
    case PrimitiveTypeKind::PTK_Float64:
        this->value.float64Value = newValue;
...
void AnySimple::SetValue(::Smp::PrimitiveTypeKind kind,
    ...
    case PrimitiveTypeKind::PTK_UInt16:
        ...
        break;
    case PrimitiveTypeKind::PTK_UInt32:
        this->value.uInt32Value = convertIntegral<::Smp::UInt32>(newValue, kind,
                PrimitiveTypeKind::PTK_UInt64);
        break;
    case PrimitiveTypeKind::PTK_UInt64:
        this->value.uInt64Value = newValue;
    ...
    case PrimitiveTypeKind::PTK_Int32:
        ...
        break;
    case PrimitiveTypeKind::PTK_Int64:
        this->value.int64Value = convertIntegral<::Smp::Int64>(newValue, kind,
                PrimitiveTypeKind::PTK_UInt64);
        break;
    case PrimitiveTypeKind::PTK_DateTime:
        this->value.dateTimeValue = convertIntegral<::Smp::DateTime>(newValue,
                kind, PrimitiveTypeKind::PTK_UInt64);
        break;
    case PrimitiveTypeKind::PTK_Duration:
        this->value.durationValue = convertIntegral<::Smp::Duration>(newValue,
                kind, PrimitiveTypeKind::PTK_UInt64);
        break;
    case PrimitiveTypeKind::PTK_Float32:
        this->value.float32Value = convertFloat<::Smp::Float32>(newValue, kind,
        ...
        break;
    case PrimitiveTypeKind::PTK_Float64:
        this->value.float64Value = convertFloat<::Smp::Float64>(newValue, kind,
                PrimitiveTypeKind::PTK_UInt64);
        break;
    default:
        ::Xsmp::Exception::throwInvalidAnyType(nullptr, kind,
...
void AnySimple::SetValue(::Smp::PrimitiveTypeKind kind, ::Smp::Int8 newValue) {
    ...
    case PrimitiveTypeKind::PTK_UInt32:
        ...
        break;
    case PrimitiveTypeKind::PTK_UInt64:
        this->value.uInt64Value = convertIntegral<::Smp::UInt64>(newValue, kind,
                PrimitiveTypeKind::PTK_Int8);
        break;
    case PrimitiveTypeKind::PTK_Int8:
...
bool ::Smp::AnySimple::operator==(const ::Smp::AnySimple &other) const {
    try {
        ...
        case PrimitiveTypeKind::PTK_Float32:
            return std::fabs(
                    value.float32Value - static_cast<::Smp::Float32>(other))
                    <= std::numeric_limits<Float32>::epsilon();
        case PrimitiveTypeKind::PTK_Float64:
            return std::fabs(
                    value.float64Value - static_cast<::Smp::Float64>(other))
