...
template <typename T> class Integral : public testing::Test {};
TYPED_TEST_SUITE_P(Integral);

template <typename TypeParam, PrimitiveTypeKind kind> void check() {
  ...
  EXPECT_THROW((AnySimple{PrimitiveTypeKind::PTK_None, min}),
               ::Smp::InvalidAnyType);
  EXPECT_THROW((AnySimple{PrimitiveTypeKind::PTK_String8, min}),
               ::Smp::InvalidAnyType);
  EXPECT_THROW((AnySimple{PrimitiveTypeKind::PTK_Char8, min}),
               ::Smp::InvalidAnyType);
  ...
  // expectedMin > min
    ...
    EXPECT_NO_THROW((AnySimple{kind, min})) << kind;
    EXPECT_NO_THROW((static_cast<TypeParam>(AnySimple{kind, expectedMin})))
        << kind;
    EXPECT_THROW((static_cast<TypeParam>(AnySimple{kind, min})),
                 ::Smp::InvalidAnyType)
        << kind;
  }
  ...
  // max > expectedMax
    ...
    EXPECT_NO_THROW((AnySimple{kind, max})) << kind;
    EXPECT_NO_THROW((static_cast<TypeParam>(AnySimple{kind, expectedMax})))
        << kind;
    EXPECT_THROW((static_cast<TypeParam>(AnySimple{kind, max})),
                 ::Smp::InvalidAnyType)
        << kind;
  }
}
...
TEST(AnySimpleTest, Bool) {
  ...
  EXPECT_THROW(static_cast<bool>(AnySimple{PrimitiveTypeKind::PTK_Float32, 1}),
               ::Smp::InvalidAnyType);
  EXPECT_THROW(static_cast<bool>(AnySimple{PrimitiveTypeKind::PTK_Float64, 1}),
               ::Smp::InvalidAnyType);
}
...
TEST(AnySimpleTest, Char8) {
  ...
  EXPECT_EQ(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_Char8, 'a'}),
      'a');
  ...
  EXPECT_THROW(static_cast<::Smp::Char8>(AnySimple{}), ::Smp::InvalidAnyType);

  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_Bool, false}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_Int8, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_Int16, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_Int32, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_Int64, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_UInt8, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_UInt16, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_UInt32, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_UInt64, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_Float32, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_Float64, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_Duration, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::Char8>(AnySimple{PrimitiveTypeKind::PTK_DateTime, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(static_cast<::Smp::Char8>(
                   AnySimple{PrimitiveTypeKind::PTK_String8, "test"}),
               ::Smp::InvalidAnyType);
}
...
TEST(AnySimpleTest, String8) {
  ...
  EXPECT_THROW(static_cast<::Smp::String8>(AnySimple{}), ::Smp::InvalidAnyType);

  EXPECT_THROW(static_cast<::Smp::String8>(
                   AnySimple{PrimitiveTypeKind::PTK_Bool, false}),
               ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::String8>(AnySimple{PrimitiveTypeKind::PTK_Int8, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::String8>(AnySimple{PrimitiveTypeKind::PTK_Int16, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::String8>(AnySimple{PrimitiveTypeKind::PTK_Int32, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::String8>(AnySimple{PrimitiveTypeKind::PTK_Int64, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::String8>(AnySimple{PrimitiveTypeKind::PTK_UInt8, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::String8>(AnySimple{PrimitiveTypeKind::PTK_UInt16, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::String8>(AnySimple{PrimitiveTypeKind::PTK_UInt32, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::String8>(AnySimple{PrimitiveTypeKind::PTK_UInt64, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::String8>(AnySimple{PrimitiveTypeKind::PTK_Float32, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::String8>(AnySimple{PrimitiveTypeKind::PTK_Float64, 0}),
      ::Smp::InvalidAnyType);
  EXPECT_THROW(static_cast<::Smp::String8>(
                   AnySimple{PrimitiveTypeKind::PTK_Duration, 0}),
               ::Smp::InvalidAnyType);
  EXPECT_THROW(static_cast<::Smp::String8>(
                   AnySimple{PrimitiveTypeKind::PTK_DateTime, 0}),
               ::Smp::InvalidAnyType);
  EXPECT_THROW(
      static_cast<::Smp::String8>(AnySimple{PrimitiveTypeKind::PTK_Char8, 'a'}),
      ::Smp::InvalidAnyType);
}
...
TEST(AnySimpleTest, Float32) {
  ...
  EXPECT_NO_THROW((
      AnySimple{PrimitiveTypeKind::PTK_Float32, static_cast<::Smp::Int16>(0)}));
  EXPECT_NO_THROW((
      AnySimple{PrimitiveTypeKind::PTK_Float32, static_cast<::Smp::Int32>(0)}));
  EXPECT_NO_THROW((
      AnySimple{PrimitiveTypeKind::PTK_Float32, static_cast<::Smp::Int64>(0)}));
  EXPECT_NO_THROW((
      AnySimple{PrimitiveTypeKind::PTK_Float32, static_cast<::Smp::UInt8>(0)}));
  ...
  EXPECT_THROW((AnySimple{PrimitiveTypeKind::PTK_Float32,
                          std::numeric_limits<::Smp::Int32>::max()}),
               ::Smp::InvalidAnyType);
  EXPECT_THROW((AnySimple{PrimitiveTypeKind::PTK_Float32,
                          std::numeric_limits<::Smp::Int64>::max()}),
               ::Smp::InvalidAnyType);
  EXPECT_THROW((AnySimple{PrimitiveTypeKind::PTK_Float32,
  ...
  EXPECT_NO_THROW(
      static_cast<::Smp::Float32>(AnySimple{PrimitiveTypeKind::PTK_Int8, 0}));
  EXPECT_NO_THROW(
      static_cast<::Smp::Float32>(AnySimple{PrimitiveTypeKind::PTK_Int16, 0}));
  EXPECT_NO_THROW(
      static_cast<::Smp::Float32>(AnySimple{PrimitiveTypeKind::PTK_UInt8, 0}));
  EXPECT_NO_THROW(
...
TEST(AnySimpleTest, Float64) {
  ...
  EXPECT_NO_THROW(
      (AnySimple{PrimitiveTypeKind::PTK_Float64, static_cast<::Smp::Int8>(0)}));
  EXPECT_NO_THROW((
      AnySimple{PrimitiveTypeKind::PTK_Float64, static_cast<::Smp::Int16>(0)}));
  EXPECT_NO_THROW((
      AnySimple{PrimitiveTypeKind::PTK_Float64, static_cast<::Smp::Int32>(0)}));
  EXPECT_NO_THROW((
      AnySimple{PrimitiveTypeKind::PTK_Float64, static_cast<::Smp::Int64>(0)}));
  EXPECT_NO_THROW((
      AnySimple{PrimitiveTypeKind::PTK_Float64, static_cast<::Smp::UInt8>(0)}));
  ...
  EXPECT_NO_THROW(
      static_cast<::Smp::Float64>(AnySimple{PrimitiveTypeKind::PTK_Int8, 0}));
  EXPECT_NO_THROW(
      static_cast<::Smp::Float64>(AnySimple{PrimitiveTypeKind::PTK_Int16, 0}));
  EXPECT_NO_THROW(
      static_cast<::Smp::Float64>(AnySimple{PrimitiveTypeKind::PTK_Int32, 0}));
  EXPECT_NO_THROW(
      static_cast<::Smp::Float64>(AnySimple{PrimitiveTypeKind::PTK_UInt8, 0}));
  EXPECT_NO_THROW(
      static_cast<::Smp::Float64>(AnySimple{PrimitiveTypeKind::PTK_UInt16, 0}));
  EXPECT_NO_THROW(
