...
struct StructTest {
    ...
    struct _Field: public _BASE {
        ...
        _Field(::Smp::Publication::ITypeRegistry *typeRegistry,
                ...
                booleanInput { typeRegistry, ::Smp::Uuids::Uuid_Bool,
                        "booleanInput", "", this, view, value.booleanInput },
                /// char8Input initialization
                char8Input { typeRegistry, ::Smp::Uuids::Uuid_Char8,
                        "char8Input", "", this, view, value.char8Input } {
        }
        ...
        operator StructTest() const noexcept {
            return {booleanInput, char8Input};
        }
...
TEST(StructureFieldTest, Instanciate) {
    ...
    pStructure->AddField("booleanInput", "", ::Smp::Uuids::Uuid_Bool ///UUID of the Field Type
            , offsetof(StructTest, booleanInput) ///Compute the offset of the current item
                    , ::Smp::ViewKind::VK_None  ///viewkind
            , true  ///state
            , true  ///is an input field
            , false  ///is an output field
            );
    pStructure->AddField("char8Input", "", ::Smp::Uuids::Uuid_Char8 ///UUID of the Field Type
            , offsetof(StructTest, char8Input) ///Compute the offset of the current item
                    , ::Smp::ViewKind::VK_None  ///viewkind
            , true  ///state
            , true  ///is an input field
            , false  ///is an output field
