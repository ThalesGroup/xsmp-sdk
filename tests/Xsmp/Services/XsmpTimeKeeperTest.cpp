...
TEST(XsmpTimeKeeperTest, simulationTime) {
  ...
  // check that InvalidSimulationTime is thrown if new simulation time is less
  // than current simulation time
  ...
  // check that InvalidSimulationTime is thrown in new simulation time is > to
  // next event time
