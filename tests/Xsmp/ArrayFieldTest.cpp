...
static_assert(std::is_base_of_v<Smp::ISimpleField, field::transient::value_type>);
static_assert(!std::is_base_of_v<Smp::IDataflowField, field::transient::value_type>);
static_assert(!std::is_base_of_v<Smp::IForcibleField, field::transient::value_type>);
static_assert(!std::is_base_of_v<Smp::IArrayField, field::transient::value_type>);
static_assert(!std::is_base_of_v<Smp::ISimpleArrayField, field::transient::value_type>);
static_assert(!std::is_base_of_v<Smp::IStructureField, field::transient::value_type>);
...
static_assert(std::is_base_of_v<Smp::IDataflowField, field::output::value_type>);
static_assert(!std::is_base_of_v<Smp::IForcibleField, field::output::value_type>);
static_assert(!std::is_base_of_v<Smp::IArrayField, field::output::value_type>);
static_assert(!std::is_base_of_v<Smp::ISimpleArrayField, field::output::value_type>);
static_assert(!std::is_base_of_v<Smp::IStructureField, field::output::value_type>);
...
static_assert(std::is_base_of_v<Smp::ISimpleField, field::forcible::value_type>);
static_assert(!std::is_base_of_v<Smp::IDataflowField, field::forcible::value_type>);
static_assert(std::is_base_of_v<Smp::IForcibleField, field::forcible::value_type>);
static_assert(!std::is_base_of_v<Smp::IArrayField, field::forcible::value_type>);
static_assert(!std::is_base_of_v<Smp::ISimpleArrayField, field::forcible::value_type>);
static_assert(!std::is_base_of_v<Smp::IStructureField, field::forcible::value_type>);
...
static_assert(!std::is_base_of_v<Smp::IDataflowField, field::failure::value_type>);
static_assert(!std::is_base_of_v<Smp::IForcibleField, field::failure::value_type>);
static_assert(!std::is_base_of_v<Smp::IArrayField, field::failure::value_type>);
static_assert(!std::is_base_of_v<Smp::ISimpleArrayField, field::failure::value_type>);
static_assert(!std::is_base_of_v<Smp::IStructureField, field::failure::value_type>);
...
TEST(ArrayFieldTest, BoolType) {
    ...
    typeRegistry.AddArrayType("BoolArray", "", Smp::Uuid { },
...
TEST(ArrayFieldTest, Int8Type) {
    ...
    typeRegistry.AddArrayType("Int8Array", "", Smp::Uuid { },
...
TEST(ArrayFieldTest, EnumType) {
    ...
    field[0].SetValue( { ::Smp::PrimitiveTypeKind::PTK_Int32,
