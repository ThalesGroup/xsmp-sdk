...
static_assert(!std::is_base_of_v<Smp::ISimpleArrayField, field::failure::output>);
...
static_assert(!std::is_base_of_v<Smp::ISimpleArrayField, field::output::failure>);
...
static_assert(!std::is_base_of_v<Smp::ISimpleArrayField, field::forcible::output>);
static_assert(!std::is_base_of_v<Smp::IStructureField, field::forcible::output>);
...
static_assert(!std::is_base_of_v<Smp::ISimpleArrayField, field::output::forcible>);
static_assert(!std::is_base_of_v<Smp::IStructureField, field::output::forcible>);
...
TEST(SimpleFieldTest, BoolType) {
    ...
    Field<bool>::forcible::failure toStore { &typeRegistry,
            Smp::Uuids::Uuid_Bool, "name" };
    toStore.Force(true);
    toStore.Fail();
    ...
    Field<bool>::forcible::failure toRestore { &typeRegistry,
            Smp::Uuids::Uuid_Bool, "name" };
...
TEST(SimpleFieldTest, Int8Type) {
    ...
    Field<::Smp::Int8>::forcible::failure toRestore { &typeRegistry,
            Smp::Uuids::Uuid_Int8, "name" };
    toRestore.Restore(&storage);
